package com.example.ticketing_system_spring_boot.Entities;
...
public class Configuration {
    ...
    public Configuration(Long id, int maxTicketCapacity, int customerRetrievalRate, int ticketReleaseRate) {
        this.id = id;
        this.maxTicketCapacity = maxTicketCapacity;
        this.customerRetrievalRate = customerRetrievalRate;
        this.ticketReleaseRate = ticketReleaseRate;
    ...
    public Configuration(long l, int i) {
    }
}
